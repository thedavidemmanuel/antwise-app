...
const AirtelMoney = () => {
  ...
  const [phoneNumber, setPhoneNumber] = useState<string>('+250 730 456 789');
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeTitle}>Add Money via Airtel Money</Text>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.phoneContainer}>
              <Feather name="phone" size={20} color="#E40000" style={styles.phoneIcon} />
          ...
          <View style={styles.infoSection}>
            <View style={styles.infoItem}>
              <Feather name="info" size={16} color="#E40000" />
              <Text style={styles.infoText}>
                Make sure you have enough balance in your Airtel Money account.
              </Text>
            </View>
            <View style={styles.infoItem}>
              <Feather name="shield" size={16} color="#E40000" />
              <Text style={styles.infoText}>
