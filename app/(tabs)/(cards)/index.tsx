...
const styles = StyleSheet.create({
  ...
  cardList: {
    paddingTop: 10,
    paddingBottom: 10, // Reduced padding bottom
  },
  cardContainer: {
    width: CARD_WIDTH,
    ...Platform.select({
  ...
  cardHeader: {
    ...
    justifyContent: 'space-between',
    alignItems: 'center',
    marginBottom: 20, // Reduced from 30 to make more space for balance
  },
  cardTypeContainer: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  cardIndicatorContainer: {
    ...
    justifyContent: 'center',
    marginTop: 5,
    marginBottom: 8, // Reduced from 20 to 8 - reducing space between cards and buttons
  },
  cardIndicator: {
    width: 8,
    height: 8,
